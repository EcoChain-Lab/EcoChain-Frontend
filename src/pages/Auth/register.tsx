...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Left Panel - Visual */}
      <div className="flex-1 bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 relative overflow-hidden flex items-center justify-center">
        <div className="text-center text-white z-10 animate-slide-in-left">
          <div className="bg-white/20 backdrop-blur-sm border-4 border-white p-12 shadow-[12px_12px_0px_0px_rgba(255,255,255,0.3)] mb-8">
            ...
            <p className="text-xl font-bold mb-8">BE PART OF THE GLOBAL MOVEMENT TOWARDS A SUSTAINABLE FUTURE</p>
        ...
        <div className="absolute top-20 right-10 w-28 h-28 bg-white/20 border-4 border-white transform rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-32 left-16 w-20 h-20 bg-white/20 border-4 border-white transform -rotate-12 animate-bounce"></div>
        <div className="absolute top-1/3 right-1/4 w-12 h-12 bg-white/30 border-4 border-white rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/3 w-16 h-16 bg-white/20 border-4 border-white transform rotate-12 animate-ping"></div>
        ...
        {floatingElements.map((element) => (
          ...
          >
            <div className="w-4 h-4 bg-white/40 border-2 border-white transform rotate-45"></div>
          </div>
        ))}
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="block font-black uppercase text-sm">FIRST NAME</label>
                ...
                <div className="space-y-2">
                  <label className="block font-black uppercase text-sm">LAST NAME</label>
                  <Input
                    type="text"
                    value={formData.lastName}
                    onChange={(e) => handleInputChange("lastName", e.target.value)}
                    placeholder="DOE"
                    className="border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-bold uppercase placeholder:text-gray-400 focus:border-green-600 transition-colors duration-300"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="block font-black uppercase text-sm">CONFIRM PASSWORD</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-500" />
                  <Input
              ...
              <div className="flex items-start gap-3">
                <input type="checkbox" className="w-5 h-5 border-2 border-black accent-green-600 mt-1" required />
